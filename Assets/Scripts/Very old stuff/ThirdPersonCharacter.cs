...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        void Start()
		{
            ...
            cameraSteps = cameraTurningSpeed * Time.deltaTime;
        ...
        public void Move(Vector3 move, bool crouch, bool jump)
        {
                ...
                transform.rotation = Quaternion.RotateTowards(transform.rotation, m_Cam.rotation, cameraSteps);
		...
		void UpdateAnimator(Vector3 move)
		{
            ...
            m_Animator.SetFloat("AttackStyle", m_AttackStyle, 1f, Time.deltaTime);
			if (!m_IsGrounded)
			{
